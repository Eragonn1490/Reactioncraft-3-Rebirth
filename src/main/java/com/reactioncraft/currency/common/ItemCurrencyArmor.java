...
public class ItemCurrencyArmor extends ItemArmor implements ItemModelProvider
{
    ...
    {
    	ItemStack Crown = new ItemStack(IntegratedItems.Crown);
        ...
        return itemstack != Crown && itemstack != KinglyChest && itemstack != KinglyBoots ? (itemstack == KinglyLegs ? "reactioncraft:textures/models/armor/goldcrown_layer_2.png" : null) : "reactioncraft:textures/models/armor/goldcrown_layer_1.png";
    }
