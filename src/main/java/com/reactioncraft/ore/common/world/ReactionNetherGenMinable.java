...
public class ReactionNetherGenMinable extends WorldGenerator
{
    ...
    public ReactionNetherGenMinable(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockStateMatcher.forBlock(IntegratedBlocks.netherOres).where(BlockNOMulti.TYPE, v->v==EnumNores.two2));
    }

    public ReactionNetherGenMinable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
