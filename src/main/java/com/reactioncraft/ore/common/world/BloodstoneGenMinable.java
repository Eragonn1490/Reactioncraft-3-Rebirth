...
public class BloodstoneGenMinable extends WorldGenerator
{
    ...
    public BloodstoneGenMinable(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockMatcher.forBlock(Blocks.NETHERRACK));
    }

    public BloodstoneGenMinable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
