...
import com.reactioncraft.machines.common.BlockClayalizer;
...
public class TileEntityClayalizer extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockClayalizer.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = FreezerRecipes.instance().getSmeltingResult(this.furnaceItemStacks[0]);
