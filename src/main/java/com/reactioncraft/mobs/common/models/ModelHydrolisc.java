...
import com.reactioncraft.mobs.common.EntityHydrolisc;
...
public class ModelHydrolisc extends ModelBase
{
    ...
    public ModelHydrolisc(float f1)
    {
        ...
        this.setRotation(this.rb4, -((float)Math.PI / 5F), 0.0F, 0.0F);
        ...
        this.setRotation(this.rb5, -((float)Math.PI / 5F), 0.0F, 0.0F);
        ...
        this.setRotation(this.lb5, -((float)Math.PI / 5F), 0.0F, 0.0F);
        ...
        this.setRotation(this.lb4, -((float)Math.PI / 5F), 0.0F, 0.0F);
        ...
        this.setRotation(this.rf4, -((float)Math.PI / 5F), 0.0F, 0.0F);
        ...
        this.setRotation(this.rf5, -((float)Math.PI / 5F), 0.0F, 0.0F);
        ...
        this.setRotation(this.lf4, -((float)Math.PI / 5F), 0.0F, 0.0F);
        ...
        this.setRotation(this.lf5, -((float)Math.PI / 5F), 0.0F, 0.0F);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        this.tail2.rotationPointZ = this.tail1.rotationPointZ + (float)Math.cos((double)this.tail1.rotateAngleY) * 5.0F;
        this.tail2.rotationPointX = this.tail1.rotationPointX + (float)Math.sin((double)this.tail1.rotateAngleY) * 5.0F;
        this.tail2.rotateAngleY = newangle * 0.5F;
        this.tail3.rotationPointZ = this.tail2.rotationPointZ + (float)Math.cos((double)this.tail2.rotateAngleY) * 8.0F;
        this.tail3.rotationPointX = this.tail2.rotationPointX + (float)Math.sin((double)this.tail2.rotateAngleY) * 8.0F;
        this.tail3.rotateAngleY = newangle * 0.75F;
        newangle = MathHelper.cos(f2 * 1.25F * this.wingspeed * hf) * (float)Math.PI * 0.2F * hf;
        this.feather2.rotateAngleY = newangle;
        newangle = MathHelper.cos(f2 * 0.75F * this.wingspeed * hf) * (float)Math.PI * 0.2F * hf;
