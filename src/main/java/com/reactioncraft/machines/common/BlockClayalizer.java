...
import com.reactioncraft.core.common.tileEntities.TileEntityClayalizer;
...
public class BlockClayalizer extends BlockContainer
{
    ...
    {
        return Item.getItemFromBlock(IntegratedBlocks.ClayalizerIdle);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            {
                playerIn.displayGUIChest((TileEntityClayalizer)tileentity);
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, IntegratedBlocks.ClayalizerActive.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, IntegratedBlocks.ClayalizerActive.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, IntegratedBlocks.ClayalizerIdle.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, IntegratedBlocks.ClayalizerIdle.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityClayalizer)
            {
                ((TileEntityClayalizer)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    {
        return new ItemStack(IntegratedBlocks.ClayalizerIdle);
    }
